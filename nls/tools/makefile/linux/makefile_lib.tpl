...
$(DOBJ)/%.o : %.c ; @echo $< ; $(CC) -MD -rdynamic -o $@ -c $(CFLAGSD) $(CFLAGSD_INTERNAL) $(ADD_INC) -DDPcInDll $(ADD_CFLAGS) $<
...
$(DOBJ)/%.o : %.cpp ; @echo $< ; $(CPP) -MD -rdynamic -o $@ -c $(CFLAGSD) $(CFLAGSD_INTERNAL) $(ADD_INC) -DDPcInDll $(ADD_CFLAGS) $<
