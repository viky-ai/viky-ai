/*
 * Handling code page 1250 very close to 8859-2.
...
static unsigned OgCp1250[256];

/*
 *  Changes a Unicode char to a cp1250 char. This function returns 
 *  a truncated char if the Unicode code does not correspond.
*/

PUBLIC(int) OgUniToCp1250(u,truncated)
int u,*truncated;
{
if (truncated) *truncated=0;
switch(u) {
  /** This part is normally a control zone in 8859-2, but we keep the 1250 on this **/
  ...
  case 0x015B: return(0x9C);  /* LATIN SMALL LIGATURE OE */
  case 0x0165: return(0x9D);  /* LATIN CAPITAL LETTER Y WITH DIAERESIS */
  case 0x017E: return(0x9E);  /* LATIN CAPITAL LETTER Y WITH DIAERESIS */
  case 0x017A: return(0x9F);  /* #LATIN SMALL LETTER Z WITH ACUTE */
  /** The good ISO-Latin 2 (8859-2) zone **/
...
PUBLIC(int) OgCp1250ToUni(c)
int c;
{
if (c<256) return(OgCp1250[c]);
else return(c);
}
...
static unsigned OgCp1250[256] = {
  ...
  0x0083, /* 0x83  UNDEFINED */
  0x201E, /* 0x84  DOUBLE LOW-9 QUOTATION MARK */
  0x2026, /* 0x85  HORIZONTAL ELLIPSIS */
  0x2020, /* 0x86  DAGGER */
  0x2021, /* 0x87  DOUBLE DAGGER */
  0x0088, /* 0x88  UNDEFINED */
