...
og_status NlpRequestInputPartLog(og_nlp_th ctrl_nlp_th, int Irequest_input_part)
{
  ...
  OgMsg(ctrl_nlp_th->hmsg, "", DOgMsgDestInLog, "%4d: %s %d,%d in package '%s' '%s'", Irequest_input_part,
      string_input_part, request_input_part->Iinterpret_package, request_input_part->Iinput_part, package_slug, package_id);
