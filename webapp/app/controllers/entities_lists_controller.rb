class EntitiesListsController < ApplicationController
  ...
  def get_used_by_intents
    ...
    render partial: 'intents/used_by_intents_list', locals: {intents_list: used_by_intents_list, entities_list: @entities_list, is_intent: false, agent_owner: @owner, agent: @agent, from_list: params[:from_list]}
  end
